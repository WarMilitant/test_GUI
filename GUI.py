    ...
    def load_font(self, path):
        ...
        if platform.system() == "Linux":
            ...
            def install_font(src_path):
                ...
                font_path_exists = os.environ['USERPROFILE'], 'AppData\Local\Microsoft\Windows\Fonts'
                if os.path.exits(font_path_exists):
                    dst_path = os.path.join(
                        font_path_exists, os.path.basename(src_path)
                    )
